...
$(function(){
    ...
    $('.modal__block').on('click',function(){event.stopPropagation()})
...
if (typeof exports === "object") {
    ...
    */
    ...
    $('#show-dd').on('click', function() {
        event.preventDefault();
        if ($('#dd-services').is(':visible')) {
            $('#dd-services').slideUp(1100);
            $('.d-head-bg').css({"opacity": '0'});
            $(this).removeClass('open');
        }
        else {
            $(this).addClass('open');
            $('#dd-services').slideDown(1100);
            $('.d-head-bg').css({"opacity": '1'});
        }
        return false;
    })
    ...
    $('.dropdown').on('click', function() {
        ...
        if (!$('.m-nav-dropdown>.dropdown-menu').is(':visible')) {
            $('.d-head-bg').css({"opacity": '1'});
        }
        if ($(this).children('.dropdown-menu').is(':visible')) {
            $(this).children('.dropdown-menu').slideUp(600);
        }
        else {
            $(this).children('.dropdown-menu').slideDown(600);
        }
        return false;
    })


    $('.m-nav-dropdown').on('click', function() {
        $(this).toggleClass('open');
        if (!$('.m-nav-dropdown>.dropdown-menu').is(':visible')) {
            $('.d-head-bg').css({"opacity": '1'});
        }
